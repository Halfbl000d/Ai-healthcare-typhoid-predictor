            ...
            <div className="mb-10 max-w-[570px] lg:mb-0 px-4">
              ...
              <div className="mb-8 flex w-full max-w-[370px]">
                ...
                <div className="w-full">
                  ...
                  <p className="text-sm italic text-gray-700">Kathmandu</p>
                </div>
              </div>
              ...
              <div className="mb-8 flex w-full max-w-[370px]">
                ...
                <div className="w-full">
                  ...
                  <p className="text-sm italic text-gray-700">+977 9009009009</p>
                </div>
              </div>
              ...
              <div className="mb-8 flex w-full max-w-[370px]">
                ...
                <div className="w-full">
                  ...
                  <p className="text-sm italic text-gray-700">kattagang123work@gmail.com</p>
                </div>
              </div>
            </div>
          </div>
